              ...
              <div className="row">
                <div className="col-xlg-12 form-group form-material">
                  ...
                  <input
                    ...
                    required />
                    { this.state.sendTo && !this.state.formValidation.sendToAddress && <span class="label label-danger">{translate("SEND.SEND_TO_ADDRESS_VALIDATE")}</span> }
                </div>
                <div className="col-lg-6 form-group form-material">
                ...
                <div className="col-lg-12">
                  <button
                    ...
                    disabled={ !this.state.sendFrom || !this.state.sendTo || !this.state.amount || !this.state.formValidation.sendToAddress }>
