...
class ReceiveCoin extends React.Component {
  render() {
    return (
      <div className="page" data-animsition-in="fade-in" data-animsition-out="fade-out" style={{margin-left: '0'}}>
        <div className="page-content" data-extcoin="COIN" id="section-extcoin">
          <div role="alert" className="alert alert-danger alert-dismissible" data-extcoin="COIN" id="extcoin-wallet-connection-alert" style="display: none">
          ...
          <div role="alert" className="alert alert-info alert-dismissible" data-extcoin="COIN" id="extcoin-wallet-activating-alert" style="display: none">
            <button aria-label="Close" data-dismiss="alert" className="close" type="button">
              <span aria-hidden="true">×</span>
            </button>
            <h4>
          ...
          <div className="row" data-extcoin="COIN" id="extcoin-wallet" data-plugin="masonry">
            ...
            <div data-extcoin="COIN" id="kmd_wallet_settings" style="display: none">
              <div className="col-xlg-6 col-md-4">
                ...
                <div className="panel" id="projects">
                  <div className="panel-heading">
                    <h3 className="panel-title" data-lang="INDEX.WALLET_INFO"></h3>
                  </div>
            ...
            <div className="modal-dialog modal-center modal-lg">
              <div className="modal-content">
                <!--<div className="modal-header bg-orange-a400 wallet-send-header">
                  ...
                  <h4 className="modal-title white"><span className="icon fa-search" style="margin: 0"></span> Transaction ID <span id="mdl_txid_info_coin_name"></span></h4>
                </div>-->
