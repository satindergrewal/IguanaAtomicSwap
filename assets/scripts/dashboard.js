                    ...
                    $.each(AllcoinsDataOutput[value], function(index) {
                        ...
                        $.ajax({
                            ...
                            success: function(data, textStatus, jqXHR) {
                                ...
                                console.log(testhistory.received);
                                /*<tr>
                                    <td><span class="label label-xs label-danger"><i class="icon fa-arrow-right"></i></span></td>
                                    <td class="hidden-xs">1LkTfkQLXg2v86oc1MoLz68nKoshh5ARTC</td>
                                    <td>Just now</td>
                                    <td><span style="color: #f44336;">2.36224</span></td>
                                </tr>*/
